...
INSERT INTO partner (id, username, email, password, email_verified_at, image, gender, first_name, last_name, phone,rate_avg, active)
...
VALUE (1, 1, 1, '333', '333',  '123456789',  'HN','1','', '1');

INSERT INTO issue(id, user_id,partner_id, longitude, latitude,category, phone,address,description, status) 
VALUE (2, 2, 2, '5555', '5555',  '123456789',  'HN','1','', '1');

INSERT INTO issue(id, user_id,partner_id, longitude, latitude,category, phone,address,description, status) 
VALUE (3, 3, 3, '6665', '6665',  '123456789',  'HN','2','', '1');

INSERT INTO issue(id, user_id,partner_id, longitude, latitude,category, phone,address,description, status) 
VALUE (4, 4, 4, '775', '775',  '123456789',  'HN','1','', '1');

INSERT INTO issue(id, user_id,partner_id, longitude, latitude,category, phone,address,description, status) 
VALUE (5, 5, 5, '88', '333',  '123456789',  'HN','1','', '1');

INSERT INTO issue(id, user_id,partner_id, longitude, latitude,category, phone,address,description, status) 
VALUE (6, 6, 6, '333', '5555',  '123456789',  'HN','2','', '1');

INSERT INTO issue(id, user_id,partner_id, longitude, latitude,category, phone,address,description, status) 
VALUE (7, 7, 7, '5555', '6665',  '123456789',  'HN','1','', '1');

INSERT INTO issue(id, user_id,partner_id, longitude, latitude,category, phone,address,description, status) 
VALUE (8, 8, 8, '6665', '775',  '123456789',  'HN','1','', '1');

INSERT INTO issue(id, user_id,partner_id, longitude, latitude,category, phone,address,description, status) 
VALUE (9, 9, 9, '775', '333',  '123456789',  'HN','2','', '1');

INSERT INTO issue(id, user_id,partner_id, longitude, latitude,category, phone,address,description, status) 
VALUE (10, 10, 10, '88', '5555',  '123456789',  'HN','1','', '1');

INSERT INTO issue(id, user_id,partner_id, longitude, latitude,category, phone,address,description, status) 
VALUE (11, 11, 11, '775', '6665',  '123456789',  'HN','1','', '1');

INSERT INTO issue(id, user_id,partner_id, longitude, latitude,category, phone,address,description, status) 
VALUE (12, 12, 12, '88', '775',  '123456789',  'HN','2','', '1');
...
INSERT INTO ratingPartner (id, user_id, partner_id,issue_id, rate_point, comment) 
VALUE (1, 1, '1','1', '3', 'Very good.');

INSERT INTO ratingPartner (id, user_id, partner_id,issue_id, rate_point, comment) 
VALUE (2, 2, '2','2', '5', 'Good ');

INSERT INTO ratingPartner (id, user_id, partner_id,issue_id, rate_point, comment) 
VALUE (3, 3, '3','3', '5', 'Very good.');

INSERT INTO ratingPartner (id, user_id, partner_id,issue_id, rate_point, comment) 
VALUE (4, 4, '4','4', '5', 'Very good.');

INSERT INTO ratingPartner (id, user_id, partner_id,issue_id, rate_point, comment) 
VALUE (5, 5, '5','5', '5', 'Good ');

INSERT INTO ratingPartner (id, user_id, partner_id,issue_id, rate_point, comment) 
VALUE (6, 6, '6','6', '4', 'Very good.');

INSERT INTO ratingPartner (id, user_id, partner_id,issue_id, rate_point, comment) 
VALUE (7, 7, '7','7', '4', 'Very good.');

INSERT INTO ratingPartner (id, user_id, partner_id,issue_id, rate_point, comment) 
VALUE (8, 8, '8','8', '4', 'Very good.');

INSERT INTO ratingPartner (id, user_id, partner_id,issue_id, rate_point, comment) 
VALUE (9, 9, '9','9', '4', 'very good.');

INSERT INTO ratingPartner (id, user_id, partner_id,issue_id, rate_point, comment) 
VALUE (10, 10, '10','10', '4', 'Good ');

INSERT INTO ratingPartner (id, user_id, partner_id,issue_id, rate_point, comment) 
VALUE (11, 11, '11','11', '4', 'Good ');

INSERT INTO ratingPartner (id, user_id, partner_id,issue_id, rate_point, comment) 
VALUE (12, 12, '12','12', '5', 'Good ');
